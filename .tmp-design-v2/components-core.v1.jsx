      ...
      <svg
        ...
        <defs>
          <radialGradient id="sun-core" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="30%" stopColor="#d6cdff" stopOpacity="1" />
            <stop offset="70%" stopColor="#7b6ef6" stopOpacity="0.7" />
          ...
          <radialGradient id="sun-corona" cx="50%" cy="50%" r="50%">
            ...
            <stop offset="55%" stopColor="#7b6ef6" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#7b6ef6" stopOpacity="0" />
          </radialGradient>
          <radialGradient id="planet-grad" cx="32%" cy="30%" r="78%">
            <stop offset="0%" stopColor="#f2eeff" />
            <stop offset="55%" stopColor="#9d8fff" />
            <stop offset="100%" stopColor="#3e3592" />
          </radialGradient>
        ...
        {PLANETS.map((p) => {
          ...
          return (
            <g key={`pl-${p.id}`}>
              ...
              <circle
                cx={cx} cy={cy} r={p.r}
                fill="none" stroke="#9d8fff" strokeWidth="1"
        ...
        <g transform={`translate(${cx},${cy})`}>
          ...
          {/* chip core */}
          <circle r="53" fill="#0e0e18" stroke="#9d8fff" strokeWidth="1.4">
            <animate attributeName="stroke" values="#7b6ef6;#9d8fff;#7b6ef6" dur="3s" repeatCount="indefinite" />
...
<section className="hero">
    <div className="hero-left">
      <div className="overline fade-up">Payment infrastructure · x402 protocol</div>
      <h1 className="hero-title fade-up delay-1">
        AI bots crawl your site.{'\n'}Now they <span className="accent">pay for it.</span>
      </h1>
      <p className="hero-body fade-up delay-2">CrawlPay turns every page into a micro-API. Automated agents settle on Arc in sub-second windows - no contracts, no scraping war, no broken Terms of Service.


    </p>
      <div className="hero-buttons fade-up delay-3">
        <button className="btn-primary">Start earning →</button>
        <a href="https://crawl-pay.vercel.app" target="_blank" rel="noopener">
  ...
  return (
    <div className="terminal">
      ...
      <div className="terminal-body">
        ...
        <span className="line"><span className="tok-plain">{'  '}</span><span className="tok-prop">network</span><span className="tok-plain">: </span><span className="tok-string">'arc-testnet'</span><span className="tok-plain">,</span></span>
